...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(134);
      writeValue(buffer, value.index);
    }    else if (value is ScrollGesturePhase) {
      buffer.putUint8(135);
      writeValue(buffer, value.index);
    } else {
      super.writeValue(buffer, value);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 135:
        final value = readValue(buffer) as int?;
        return value == null ? null : ScrollGesturePhase.values[value];
      default:
        return super.readValueOfType(type, buffer);
    }
  }
...
class WebView extends View {
  ...
  /// final WeakReference weakMyVariable = WeakReference(myVariable);
  /// final WebView instance = WebView(
  ///  onScrollGesture: (WebView pigeon_instance, ...) {
  ///    print(weakMyVariable?.target);
  ///  },
  /// );
  /// ```
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.webview_flutter_android.WebView.onScrollGesture',
          pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (pigeon_clearHandlers) {
        pigeonVar_channel.setMessageHandler(null);
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          final List<Object?> args = message! as List<Object?>;
          final WebView arg_pigeon_instance = args[0]! as WebView;
          final ScrollGesturePhase arg_eventType =
              args[1]! as ScrollGesturePhase;
          final double arg_timestamp = args[2]! as double;
          final double arg_globalX = args[3]! as double;
          final double arg_globalY = args[4]! as double;
          final double arg_localX = args[5]! as double;
          final double arg_localY = args[6]! as double;
          final double arg_deltaX = args[7]! as double;
          final double arg_deltaY = args[8]! as double;
          final double arg_velocityX = args[9]! as double;
          final double arg_velocityY = args[10]! as double;
          try {
            (onScrollGesture ?? arg_pigeon_instance.onScrollGesture)?.call(
                arg_pigeon_instance,
                arg_eventType,
                arg_timestamp,
                arg_globalX,
  ...
  Future<void> setScrollGestureListening(
    bool enabled,
    bool consume,
  ) async {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
    ...
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const pigeonVar_channelName =
        'dev.flutter.pigeon.webview_flutter_android.WebView.setScrollGestureListening';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    final Future<Object?> pigeonVar_sendFuture =
        pigeonVar_channel.send(<Object?>[this, enabled, consume]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
