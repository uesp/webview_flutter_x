...
window.addEventListener("error", function(e) {
  log("error", e.message + " at " + e.filename + ":" + e.lineno + ":" + e.colno);
    ...
    test('setOnScrollGesture throws on unsupported platforms', () async {
      debugDefaultTargetPlatformOverride = TargetPlatform.iOS;
      final WebKitWebViewController controller = createControllerWithMocks();
      ...
      expect(
        () => controller.setOnScrollGesture((_) {}),
        throwsA(isA<UnimplementedError>()),
      );
    });

    test('setOnScrollGesture attaches, forwards, and detaches', () async {
      debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
      ...
      final eventCompleter = Completer<ScrollGestureEvent>();
      await controller.setOnScrollGesture(eventCompleter.complete);
      ...
      final ScrollGestureEvent event = await eventCompleter.future;
      expect(event.eventType, ScrollGesturePhase.start);
      ...
      await controller.setOnScrollGesture(null);
    ...
    test('setOnScrollGesture native monitor survives navigation', () async {
      debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
      ...
      await controller.setOnScrollGesture((_) {});
