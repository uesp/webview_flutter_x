...
class PlatformWebView {
  ...
  /// Installs an iOS scroll-gesture (pan) delegate on the web view.
  Future<void> setScrollGestureDelegate(
    UIScrollViewDelegate? delegate, {
    required bool consume,
  }) async {
    final WKWebView webView = nativeWebView;
    if (webView is UIViewWKWebView) {
      await webView.setScrollGestureDelegate(delegate, consume);
    }
  }
