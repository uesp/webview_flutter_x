...
class UIScrollView extends UIView {
  ...
  Future<void> setScrollEnabled(bool value) async {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _pigeonVar_codecUIScrollView;
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const pigeonVar_channelName =
        'dev.flutter.pigeon.webview_flutter_wkwebview.UIScrollView.setScrollEnabled';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
class UIViewWKWebView extends UIView implements WKWebView {
  ...
  Future<void> setScrollGestureDelegate(
    ...
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const pigeonVar_channelName =
        'dev.flutter.pigeon.webview_flutter_wkwebview.UIViewWKWebView.setScrollGestureDelegate';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
class UIScrollViewDelegate extends NSObject {
  ...
  /// final WeakReference weakMyVariable = WeakReference(myVariable);
  /// final UIScrollViewDelegate instance = UIScrollViewDelegate(
  ///  scrollGesture: (UIScrollViewDelegate pigeon_instance, ...) {
  ///    print(weakMyVariable?.target);
  ///  },
  /// );
  /// ```
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.webview_flutter_wkwebview.UIScrollViewDelegate.scrollGesture',
          pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (pigeon_clearHandlers) {
        pigeonVar_channel.setMessageHandler(null);
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          final double arg_velocityX = args[10]! as double;
          final double arg_velocityY = args[11]! as double;
          try {
            (scrollGesture ?? arg_pigeon_instance.scrollGesture)?.call(
                arg_pigeon_instance,
                arg_scrollView,
                arg_eventType,
                arg_timestamp,
