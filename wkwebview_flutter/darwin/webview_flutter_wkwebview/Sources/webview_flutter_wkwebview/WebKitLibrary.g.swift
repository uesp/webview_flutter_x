...
protocol PigeonApiDelegateUIScrollView {
  ...
  func setScrollEnabled(pigeonApi: PigeonApiUIScrollView, pigeonInstance: UIScrollView, value: Bool) throws
  #endif
}
...
final class PigeonApiUIScrollView: PigeonApiProtocolUIScrollView  {
  ...
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiUIScrollView?) {
    ...
    #endif
    #if !os(macOS)
    let setScrollEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.UIScrollView.setScrollEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setScrollEnabledChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! UIScrollView
        let valueArg = args[1] as! Bool
        do {
          try api.pigeonDelegate.setScrollEnabled(pigeonApi: api, pigeonInstance: pigeonInstanceArg, value: valueArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      setScrollEnabledChannel.setMessageHandler(nil)
    }
    #endif
  }
...
protocol PigeonApiDelegateUIViewWKWebView {
  ...
  func setScrollGestureDelegate(pigeonApi: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView, delegate: UIScrollViewDelegate?, consume: Bool) throws
  #endif
}
...
withIdentifier: pigeonIdentifierArg)
    ...
    #endif
    #if !os(macOS)
    let setScrollGestureDelegateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.UIViewWKWebView.setScrollGestureDelegate", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setScrollGestureDelegateChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! WKWebView
        let delegateArg: UIScrollViewDelegate? = nilOrValue(args[1])
        let consumeArg = args[2] as! Bool
        do {
          try api.pigeonDelegate.setScrollGestureDelegate(pigeonApi: api, pigeonInstance: pigeonInstanceArg, delegate: delegateArg, consume: consumeArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      setScrollGestureDelegateChannel.setMessageHandler(nil)
    }
    #endif
  }
...
protocol PigeonApiProtocolUIScrollViewDelegate {
  ...
  func scrollGesture(pigeonInstance pigeonInstanceArg: UIScrollViewDelegate, scrollView scrollViewArg: UIScrollView, eventType eventTypeArg: FWFNSScrollWheelPhase, timestamp timestampArg: Double, globalX globalXArg: Double, globalY globalYArg: Double, localX localXArg: Double, localY localYArg: Double, deltaX deltaXArg: Double, deltaY deltaYArg: Double, velocityX velocityXArg: Double, velocityY velocityYArg: Double, completion: @escaping (Result<Void, PigeonError>) -> Void)  #endif
...
withIdentifier: pigeonIdentifierArg)
  ...
  /// [velocityX] / [velocityY] are only meaningful on [FWFNSScrollWheelPhase.end]
  /// (points per second from the pan recognizer); otherwise zero.
  func scrollGesture(pigeonInstance pigeonInstanceArg: UIScrollViewDelegate, scrollView scrollViewArg: UIScrollView, eventType eventTypeArg: FWFNSScrollWheelPhase, timestamp timestampArg: Double, globalX globalXArg: Double, globalY globalYArg: Double, localX localXArg: Double, localY localYArg: Double, deltaX deltaXArg: Double, deltaY deltaYArg: Double, velocityX velocityXArg: Double, velocityY velocityYArg: Double, completion: @escaping (Result<Void, PigeonError>) -> Void)   {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          PigeonError(
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `UIScrollViewDelegate.scrollGesture` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    let channelName: String = "dev.flutter.pigeon.webview_flutter_wkwebview.UIScrollViewDelegate.scrollGesture"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([pigeonInstanceArg, scrollViewArg, eventTypeArg, timestampArg, globalXArg, globalYArg, localXArg, localYArg, deltaXArg, deltaYArg, velocityXArg, velocityYArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
        return
      }
